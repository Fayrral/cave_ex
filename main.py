...
if answer == "yes":
    ...
    if answer == 'right':
        ...
        if answer == 'approach':
           ...
           # Remove else 
            answer = input('The flask you\'ve located is full, but you\'re not sure of what. Do you chug it back or save it for later?: (chug/save) ').lower().strip()
# Path split for KEROSENE
            if answer == 'save':
                ...
                if answer == 'cabin':
                    ...
                    answer = input('Do you continue to search the cabin despite the corpse?: (yes/no) ').lower().strip()
                        ...
                        if answer == ('straight'):
                            ...
                            if answer == ('off'):
                                ...
                                if answer == ('fight'):
                                    ...
                                    answer = input('You climb down the ladder that the Ogre was guarding. He is on his stomach on the ground and is not moving.\
                                    Do you search his pockets or continue down the path?: (search/continue) ')
# Path split for JOURNAL
                                    if answer == ('search'):
                                        print('You locate a journal and place it in your pocket. You continue down the path to a locked door.')

                                        answer = input('You inspect the door and see a combination style lock. You do not know the combination.\
                                        Do you try a random combination or search through the journal for a clue?: (random/search) ')

                                        if answer == ('search'):
                                            print('You have found a combination in the journal, you try it on the door and it works!\
                                    ...
                                    # Winning Path^^^    
                                        ...
                                        answer = input('Do you wish to attempt a random combination on the door or return to search the Ogre?: (random/search')

                                        if answer == ('search'):
                                            print('You return to the Ogre but are unable to locate him, he is no longer laying on the ground.\
                                            The ladder you took into the cave has been demolished. You are trapped. Do you want to return to the door and try a random combination?: (yes/no) ').lower().strip()
                                            ...
                                            The End.')
                                                ...
                                                print('The mine caved in due to an earth quake. You Died. The End.')
                                ...
                                print('Bats swarmed you and gouged your eyes out. The End.')    
                        ...
                        print('You enter the mine shaft shaft and fall to your death. The End.')
                    
                    else:
                        print('You stayed in the cabin to long and lost your mind. The End.')
                elif answer == 'mine':
                    print('You enter the mine shaft and fall to your death. The End.')
                
                else:
                    print('You fell into an open pit and broke both of your legs. Mine\'s are dangerous. The End.')

# ^^^ Winning Path ^^^

# Path split for KEROSENE
            elif answer == 'chug':
                print('You begin to chug the contents of the flask to discover it\'s filled with kerosene. You become ill and throw the flask away.\
                    once you\'ve recovered, you continue down the trail.')
                        ...
                        if answer == ('straight'):
                            ...
                            if answer == ('off'):
                                ...
                                if answer == ('sneak'):
                                    ...
                                    print('The Ogre is massive and crushes you without hesitation. The End.')
# terminate path, no way to fight the Ogre due to lack of Kerosene
                            elif answer == ('on'):
                                print('An Ogre charges you and clubs you to death. The End.')
...
# ^^^ Losing Path ^^^  
                ...
                print('The owner of the campsite returned while you we\'re deciding what to do with the flask. He shot you and now you\'re dead. The End')
            ...
            print('You wandered off the trail and got eaten by a pack of Coyote\'s')
        ...
        print('You got lost and wandered the forest for days until you died of dehydration. The End.')
